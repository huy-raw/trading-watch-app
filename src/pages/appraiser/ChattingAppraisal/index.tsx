...
import ChatContent from '@/pages/user/Chatting/components/ChatContent'
import ChattingSideBar from '@/pages/user/Chatting/components/SideBar'
import {
  ConversationType,
  Message,
  MessageRequest
} from '@/pages/user/Chatting/type'
...
export default ChattingAppraisal
